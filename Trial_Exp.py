...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/cmml/Documents/Pupillometry_Experiment/Trial_Exp.py',
...
for i in stim_names:
    ...
    cntr+=1
import csv
save_in = '/Users/cmml/Documents/Pupillometry_Experiment/data/Random'+str(expInfo{'participant'}+.csv'
with open(save_in, 'w') as csvfile: 
    # creating a csv writer object 
    csvwriter = csv.writer(csvfile) 
        
    # writing the fields 
    csvwriter.writerow(stim_names) 
        
    # writing the data rows 
    csvwriter.writerows(stim_answers)
