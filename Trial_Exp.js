...
function StartWelcomeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of StartWelcomeComponents)
...
function PupilRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of PupilComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Ready_toneRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Ready_toneComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function reference_toneRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of reference_toneComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function comparison_toneRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of comparison_toneComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function End_toneRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of End_toneComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function stop_pupilRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of stop_pupilComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
